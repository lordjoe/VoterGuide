...
public abstract class ImplementationUtilities
{
    ...
    public static void addConverter(IStringConverter added)
    {
        synchronized (gConverters) {
            ...
            gConverters = (IStringConverter[]) ObjectOps.addToArray(gConverters, added);
        }
    }
...
//        }
     ...
     * @author Scott
     */
    public static class PointConverter implements IStringConverter<Point>
    {
        public String convertToString(Point obj)
        {
            if (obj == null)
                return "null";
        ...
        public Point convertFromString(String str)
        {
            if (str == null || "null".equals(str))
                return null;
            String[] items = str.split(",");
            return new Point(Integer.parseInt(items[0]),
                    Integer.parseInt(items[1])
            );
