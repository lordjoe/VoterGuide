 ...
 * @date Dec 8, 2004
 */
public class NibbleArray2D extends NibbleArray
{
    public static final Class THIS_CLASS = NibbleArray2D.class;
    public static final NibbleArray2D EMPTY_ARRAY[] = {};

    private final int m_RowSize;
    public NibbleArray2D(int size,int rows) {
        super(size);
        m_RowSize = rows;
    }
    ...
    public int rowColToIndex(int row,int col)
  {
    ...
    public boolean equivalent(NibbleArray2D test)
       {
