 ...
 * 
 */
public class ClassMapper  implements INameable,ITagHandler {
	...
	*
	...
	public static void main(String[] args) {
                ClassMapper test = ClassMapper.getMapper("DBTypes");
                ClassMapper test2 = ClassMapper.getMapper("DBTypes");	 
	    
		String   item = test.getValueString("Date");

		Assertion.logDebug(item);

		item = test.getValueString("PhoneNumber");

		Assertion.logDebug(item);

		item = test.getValueString("Integer");
