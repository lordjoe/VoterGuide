...
public class ClassProperty implements INameable
{
    ...
    public void setSetMethod(Method pSetMethod) {
        ...
        if( m_GetMethod == null)
            setReadOnly(m_SetMethod != null);
             ...
             setReadOnly(m_SetMethod == null || m_GetMethod.getAnnotation(ReadOnly.class) != null);
    }
    ...
    public void setGetMethod(Method pGetMethod) {
        ...
        if(m_SetMethod == null)
            ...
            ReadOnly annotation = m_GetMethod.getAnnotation(ReadOnly.class);
            setReadOnly( annotation != null);
        }
     }
    ...
    {
        String name = getName();
        boolean b = m_GetMethod.isAnnotationPresent(Required.class);

         if (!b) {
            m_Nullable = Boolean.TRUE;
            return;
        }
        else {
