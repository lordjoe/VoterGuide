...
/**
 * com.cbmx.timeout.ThreadPoolTaskRunner
 *
 * @author Steve Lewis
 * @date Apr 26, 2006
 */
...
{
    public final static ThreadPoolTaskRunner[] EMPTY_ARRAY = {};
    public final static Class THIS_CLASS = ThreadPoolTaskRunner.class;

    public static final int DEFAULT_NUMBER_THREADS = 10;
    public static final ThreadPoolTaskRunner INSTANCE = new ThreadPoolTaskRunner();
    ...
    public ThreadPoolTaskRunner(int numberThreads)
    {
       m_Pool = new ThreadPool(numberThreads);
    }
    ...
    private static class ThreadPool extends Object {
    ...
    private static class ThreadPoolWorker extends Object {
          ...
          public void run() {
            try {
              ...
              // in case ANY exception slips through
               ExceptionHandlingManager.log(x);
            }
          }
        };

        internalThread = new Thread(r,"Thread Pool Thread");
      ...
      private void runIt(Runnable r) {
        try {
          r.run();
            ...
            ExceptionHandlingManager.log(runex);
        } finally {
          Thread.interrupted();
        }
      }
...
//            .println("workerID=" + workerID + ", stopRequest() received.");
    ...
    private static class ObjectFIFO extends Object {
