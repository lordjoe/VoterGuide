 ...
 * @date Sep 26, 2008
 */
public class SubjectDisplayComponent<T> extends JPanel
        implements ISubjectDisplay<T>, MouseInputListener, IInfoTextBuilder
{
    public static SubjectDisplayComponent[] EMPTY_ARRAY = {};
    public static Class THIS_CLASS = SubjectDisplayComponent.class;
     ...
     * and a flow layout.
     */
    public SubjectDisplayComponent(Class<T> pSubjectClass)
    {
