 ...
 * @date Oct 5, 2007
 */
public class TableRemoveRenderer<T> extends AbstractCellEditor
        implements TableCellRenderer, TableCellEditor, ActionListener
{
    ...
    public TableRemoveRenderer(JTable table, int column)
    {
        super();
        this.m_Table = table;
    ...
    public void actionPerformed(ActionEvent e)
    {
        ...
        collection.removeCollectionMember(collection.getCollectionName(),(T)m_Filter);
    }
}