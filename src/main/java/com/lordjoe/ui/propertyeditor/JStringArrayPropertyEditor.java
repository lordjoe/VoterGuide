...
/**
 * com.lordjoe.ui.propertyeditor.JStringArrayPropertyEditor
 *
 * @author slewis
 * @date Apr 21, 2005
 */
public class JStringArrayPropertyEditor extends JSingleLineTextField implements IPropertyEditor<String> {
    public static final Class THIS_CLASS = JStringArrayPropertyEditor.class;
    public static final JStringArrayPropertyEditor EMPTY_ARRAY[] = {};

    private String  m_OriginalValue;
    private String  m_ValueOnEntry;
    private final IEditableProperty m_Property;

    public JStringArrayPropertyEditor(IEditableProperty prop)
    {
        m_Property = prop;
        ...
        if(realvalue != null)
            valueStr =Util.buildDelimitedString(realvalue,",");
        m_OriginalValue = valueStr;
    ...
    public String getStringValue( )
    {
        ...
        if(val instanceof String[])  {
            return Util.buildDelimitedString((String[])val,",");
        }
        return val.toString();
    }
