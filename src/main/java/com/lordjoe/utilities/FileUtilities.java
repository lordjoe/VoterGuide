 ...
 * }
 */
public abstract class FileUtilities extends Nulleton
{
     ...
     */
    public static Properties readProperties(String propName) throws IllegalArgumentException
    {
        try {
            FileInputStream fs = new FileInputStream(propName);
     ...
     * @throws IllegalArgumentException if the name is not a readable file
     */
    public static void saveProperties(String propName, Properties props)
    ...
    public static void addRequiredFiles(String[] s)
    {
        synchronized (gRequiredFiles) {
    ...
    protected static String resolveProp(String s)
    {
     ...
     * @throws IOException
     */
    public static void createDirectores(String filePath) throws IOException
    {
     ...
     */
    public static File[] stringsToFiles(String[] fileNames)
    {
     ...
     * @return
     */
    public static File makeTemporaryFile(String name)
    {
     ...
     * @UnusedParam> FileName start directory
     */
    protected static void getAllDirectoriesWithExtension(File Base, String DirectoryName,
                                                         String Extension, Vector holder)
    {
     ...
     * @function get all files ending in ext at current level
     */
    public static String[] getAllFilesWithName(String DirectoryName, String Name)
    {
     ...
     * @function get all files ending in ext at current level
     */
    public static String[] getAllFilesWithName(File DirectoryName, String Name)
    {
     ...
     * @UnusedParam> FileName start directory
     */
    public static String[] getAllFilesWithExtension(File Directory, String Extension)
    {
        if (Extension != null || Extension.length() == 0) {
            FilenameFilter TheFilter = (FilenameFilter) (new HasExtensionFilter(Extension));
    ...
    public static void renameAllFilesWithExtension(String DirectoryName, String Extension,
                                                   String NewExtension)
    {
    ...
    public static void setExtension(String FileName, String NewExtension)
    {
     ...
     * @return
     */
    public static String dropDirectories(String FileName)
    {
     ...
     * @UnusedParam> FileName start directory
     */
    public static boolean hasFileWithExtension(String DirectoryName, String Extension)
    {
        File TestFile = new File(DirectoryName);
     ...
     * @UnusedParam> FileName start directory
     */
    public static boolean hasFileWithExtension(File TestFile, String Extension)
    {
        if (!TestFile.exists()) {
            return (false);
        }
     ...
     *         }
     * @name getLatestFileWithExtension
     ...
     */
    public static long getLatestFileWithExtension(File Directory, String Extension)
    {
     ...
     * the designated extension
     */
    public static long getLatestFileFromList(File Directory, String[] testNames)
    {
        long ret = 0;
     ...
     */
    public static String[] getAllFullClasses(String BuildBase)
    {
     ...
     * @function find classes in BuildBase path and not in CaptureBase path
     */
    public static String[] differenceJavaPaths(String BuildBase, String CaptureBase)
    {
     ...
     * @UnusedParam> FileName start directory
     */
    public static String[] getFilesWithExtension(String DirectoryName, String Extension)
    {
        if (Extension != null) {
     ...
     * @function recursively get all files ending in ext
     */
    public static String[] getDirectoriesWithName(String DirectoryName, String SubDirectoryName)
    {
    ...
    public static String[] getFilesWithFilter(File pTestFile, String DirectoryName,
     ...
     * @UnusedParam> FileName starting directory
     */
    public static String[] getAllSubDirectories(String DirectoryName)
    {
        File TestFile = new File(DirectoryName);
        return getAllSubDirectories(TestFile);
    }

    public static String[] getAllSubDirectories(File pTestFile)
    {
        String test;
     ...
     * @return
     */
    public static File findSubDirectory(File pTestFile, String name)
    {
        File SubFiles[];
        String Files[];
     ...
     * @return
     */
    public static File findSubDirectoryBreadthFirst(File pTestFile, String name)
    {
     ...
     * @return
     */
    public static File findSubDirectoryBreadthFirst(File[] thislevel, List<File> nextLevel,
                                                    String name)
    {
     ...
     *      }
     */
    static public String findWildCardFile(String FileName)
    {
     ...
     *      }
     */
    static public String findWildCardFile(String DirectoryName, String FileStub)
    {
     ...
     */
    static public String fileNameToDirectoryName(String FileName)
    {
     ...
     */
    public static String[] readInParagraphs(String FileName)
    {
     ...
     */
    public static String[] readInLines(File FileName)
    {
     ...
     */
    public static String[] readInAllLines(File FileName)
    {
        String s = readInFile(FileName);
        if (s != null) {
            String[] Lines = Util.parseLines(s);
     ...
     * @function reads all the data in a file into an array of strings - one per line
     */
    public static String[] readInLines(String FileName)
    {
        String s = readInFile(FileName);
        if (s != null) {
            String[] Lines = Util.parseLines(s);
    ...
    public static Reader readerFromLines(String[] lines)
    {
     ...
     * @function reads all the data in a file into an array of strings - one per line
     */
    public static String[] readInResourceLines(Class source, String FileName)
    {
     ...
     * @function reads all the data in a file into a StringBuffer
     */
    public static StringBuffer readInFile(Reader TheFile, int len, int chunk)
    {
     ...
     * @function reads all the data in a file into a StringBuffer
     */
    public static String readInFile(URL TheFile)
    {
        InputStream is = null;
        try {
     ...
     * @function reads all the data in a file into an array of strings - one per line
     */
    public static boolean stringsToFile(String FileName, Object[] lines)
    {
        try {
     ...
     */
    public static String UnixNameFilter(String Name)
    {
        if (Name == null) {
            return (null);
        }
     ...
     */
    public static String baseFromName(String Name, String Base)
    {
     ...
     */
    public static void safeFileWrite(String fileName, String text, int numberCopies)
    {
    ...
    protected static boolean cascadingRename(String fileName, int numberCopies)
    {
    ...
    protected static boolean cascadingRename(File[] fileItems)
    {
    ...
    protected static boolean rollbackName(File[] fileItems)
    {
     ...
     *                                  the directory cannot be created
     */
    public static void guaranteeWritable(String fileName)
    {
     ...
     */
    public static boolean renameFile(String oldFile, String newFileName, boolean overwrite)
    {
        try {
     ...
     */
    public static void alphabetizeFile(String inFileName, String outFileName)
    {
    ...
    public static boolean hasExtension(File TheFile, String ext)
    {
        String Test = ext;
        if (!ext.startsWith("."))
            Test = "." + ext;
    ...
    public static boolean osIsCaseSensitive()
    {
        if (gOSIsCaseSensitive == null) {
            String osName = System.getProperty("os.name").toLowerCase();
            gOSIsCaseSensitive = new Boolean(osName.indexOf("windows") == -1);
        }
    ...
    public static boolean osIsWindows()
    {
        if (gOSIsWindows == null) {
            String osName = System.getProperty("os.name").toLowerCase();
            gOSIsWindows = new Boolean(osName.indexOf("windows") == -1);
        }
...
// Drop empty strings from lines
     ...
     * @function <Add Comment Here>
     */
    public static String[] nonEmptyStrings(String[] Lines)
    {
    ...
    public static PrintStream makePrintStream(String in)
    {
        try {
    ...
    public static void dupFile(String infile, String outfile) throws IOException
    {
    ...
    public static void dupFile(String infile, Writer out) throws IOException
    {
        FileReader in = new FileReader(infile);
        copyStream(in, out);
    }

    public static void dupFile(Reader in, String outfile) throws IOException
    {
        FileWriter out = new FileWriter(outfile);
        copyStream(in, out);
    }
     ...
     * @function get all the files in the directory
     */
    public static long getMostRecentFileDate(String DirectoryName)
    {
     ...
     * @function get all the files in the directory
     */
    public static long getMostRecentFileDate(String DirectoryName, boolean recurse)
    {
        File TestFile = new File(DirectoryName);
        String Files[];
        long ret = 0;
     ...
     */
    public static File[] getFilesAfterDate(String DirectoryName, long date)
    {
     ...
     * @function get all the files in the directory after date
     */
    public static File[] getFilesAfterDate(String DirectoryName, long date, boolean recurse)
    {
        File TestFile = new File(DirectoryName);
        if (!TestFile.exists())
            return (EMPTY_FILES);
     ...
     */
    protected static void accumulateFilesAfterDate(File TestFile, long date, boolean recurse,
                                                   Vector holder)
    {
        String[] Files = TestFile.list();
     ...
     */
    public void writeTextWithBackup(String fileName, String text)
    {
     ...
     * @param text     test to write
     */
    public static void writeTextWithBackup(File file, String text)
    {
     ...
     * @param FileName - non-null file name
     */
    public static void serializeObject(Serializable in, String FileName)
    {
        try {
     ...
     */
    public static void serializeObject(Serializable in, File TheFile)
    {
        try {
     ...
     */
    public static Object deserializeObject(File TheFile)
    {
        try {
    ...
    public static String downloadURLText(String theURl)
    {
        try {
    ...
    public static void downloadBinary(URL BaseURL, String Name, File TargetDirectory)
            throws IOException
    {
     ...
     */
    public static void guaranteeReadableFile(File t1)
    {
        if (t1 == null)
     ...
     * @param t1 non-null existing readable file
     */
    public static void guaranteeReadableDirectory(File t1)
    {
        if (t1 == null)
            throw new IllegalArgumentException("File in null");
        if (!t1.exists())
     ...
     */
    public static boolean filesAreIdentical(File t1, File t2)
    {
    ...
    public static String getNameWithoutExtension(File in)
    {
     ...
     * @throws IllegalArgumentException on error
     */
    public static File getReadableFile(String name)
    {
        File TheFile = new File(name);
        validateReadableFile(TheFile);
        return TheFile;
     ...
     * @return as above
     */
    public static boolean fileExists(String in)
    {
     ...
     */
    public static String getURLRespouse(String theMessage, URL dest)
    {
        try {
            ...
            ex1.printStackTrace();
            throw new WrapperException(ex1);
        }
    }
     ...
     * @return non-null string
     */
    public static void sendURLText(String theMessage, URL dest)
    {
        try {
            HttpURLConnection conn = (HttpURLConnection) dest.openConnection();
