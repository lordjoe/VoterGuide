...
public abstract class
    ...
    public static final Comparator STRING_COMPARE = new StringComparator();
    ...
    protected static long secondInMs = 1000L;
      protected static long minuteInMs = 60L * secondInMs;
      protected static long hourInMs = 60L * minuteInMs;
      protected static long dayInMs = 24L * hourInMs;
...
// Parsing
    ...
    private static boolean isCompatablePunctuation(StringBuffer accumType,char c)
    {
         if(Character.isDigit(c) || Character.isWhitespace(c) || Character.isJavaIdentifierPart(c))
            return false;
         if(c == '=' && (accumType.equals("<") || accumType.equals(">") || accumType.equals("=")) )
            return true;
    ...
    public static String[] uniqueSort(String[] base) {
        if (base.length == 0)
            return (EMPTY_STRING_ARRAY);
        String[] BaseClone = Clone.clone(base);
   ...
   /**{ method
    ...
    public static Enum[] getValues(Class inp)
    {
        ...
        try {
            ...
            throw new WrapperException(e); // should never happen
...
//- *******************
//- End Class Util
    protected static StackRevealer gRevealer = new StackRevealer();
     ...
     * @return non-null output string
     * @throws WrapperException on error
     */
    public static String captureExecOutput(String command)  throws WrapperException
    {
        Process p =
                null;
        try {
