...
import com.lordjoe.ui.LocaleChangeEvent;
import com.lordjoe.ui.LocaleChangeListener;
import com.lordjoe.ui.ResourceUtilities;
 ...
 */
public class JCalendar extends JPanel implements PropertyChangeListener, LocaleChangeListener {
    ...
    /**
     * respond to changes in Locale
     * @param evt non-null locale change event
     */
    public void onLocaleChange(LocaleChangeEvent evt) {
       setLocale(evt.getNewLocale());
