 ...
 *
 */
public class AllThingsCalifornia {
    ...
    public static void main(String... args) throws Exception {
        ...
        for( StateList.List.State aState: allStates.list.state ) {
            if (aState.name.equals("California")) {
                System.out.println("The stateId for California is " + aState.stateId + "\n");
                state = aState;
                break;
            }
        }
        com.lordjoe.voter.State state1 = MyVoteSmart.idToState(state.stateId);
        // Get State Details
        State stateDetail = stateClass.getState(state.stateId);
        System.out.println("California has " + stateDetail.details.area);
        System.out.println("The state bird is the " + stateDetail.details.bird );
        System.out.println("California's bicameral flag is set to " + stateDetail.details.bicameral + "\n");
        ...
        System.out.println("There are a total of " + districtList.district.size() + " districts for office " + office.name + " in "+ state.name );
        DistrictList.District district = districtList.district.get(0);
        System.out.println("The first districtId is " + district.districtId + ", called " + district.name + "\n" );
        ...
        try {
            ...
            System.out.println("There are a total of " + candidates.candidate.size() + " candidates overall for district " + district.name + "\n");
        ...
        System.out.println("There are " + zipDistrictList.district.size() + " districts for zip " + zip5 + "\n");
        ...
        System.out.println("There are " + candidates.candidate.size() + " candidates in district " + district.name + "\n" );
